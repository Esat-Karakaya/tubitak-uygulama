...
const PARAGRAPHS=[
    ...
    'Zihinsel egzersizler yapmak, beyin sağlığımızı dolayısıyla hafızamızı olumlu yönde etkileyebilir. Bulmaca çözmek, yeni bir dsil öğrenmek, enstrüman çalmak gibi zihinsel egzersizler, beynimizdeki nöron bağlantılarını güçlendirir ve yeni sinir yollarının oluşumunu teşvik eder. Bu egzersizler, zihinsel esnekliği artırır, odaklanmayı güçlendirir ve problem çözme becerilerini geliştirir. Ayrıca, düzenli zihinsel egzersizler hafıza kapasitemizi artırır ve bilişsel gerilemeyi geciktirir.',
    ...
    'Tekrar etmek, bilgiyi hafızamızda  tutma ve hatırlama sürecimizi güçlendirir. Bu yöntem, bilgiyi daha derinlemesine işlememizi ve uzun süreli belleğe aktarmamızı sağlar. Yineleme, beynimizdeki sinir bağlantılarını güçlendirir ve bilginin daha uzun süreli olarak hatırlanmamıza yardımcı olur. Kısacası, düzenli tekrarlar, öğrendiğiniz şeyleri unutmaktan koruyarak hafızamızın güçlenmesine yardımcı olur.',
];
